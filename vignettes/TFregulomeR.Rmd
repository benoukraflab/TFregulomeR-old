...
TFregulomeR allows users to easily browse a large compendium of TFBSs using only one simple
...
no input is given for the function, all records in TFregulomeR compendium will be returned.
...
Retrieval of motif matrix and DNA methylation matrix (if the source is MethMotif) can be achieved 
