#' intersectPeakMatrix
#'
#' This function allows you to obtain a numeric matrix denoting the pair-wise intersecting percentages between two lists of peak sets, as well as MethMotif logos for each pair of intersections if the original peak set is loaded from MethMotif database.
#' @param peak_list_x Required. List of data.frames, each of which contains bed-format peak regions. They are the peak sets you want to intersect with each of "peak_list_y", and can be loaded from MethMotif database or self-provided.
#' @param peak_list_y Required. List of data.frames, each of which contains bed-format peak regions. They are the peak sets you want to intersect with each of "peak_list_x", and can be loaded from MethMotif database or self-provided.
#' @param peak_id_x Required. Character of vector, each of which is a unique ID corresponding to the element in "peak_list_x". If a peak set is from MethMotif Database, its MethMotif ID should be used here.
#' @param peak_id_y Required. Character of vector, each of which is a unique ID corresponding to the element in "peak_list_y". If a peak set is from MethMotif Database, its MethMotif ID should be used here.
#' @param motif_type Required. Motif PFM format, either in MEME by default or TRANSFAC.
...
#' intersectPeakMatrix_output <- intersectPeakMatrix(peak_list_x=peak_list_x,
