...
plot(density(log2(HCT116_distances_to_TSS+1)), xlab="log2(distance to TSS)", main="HCT116 ATF3 peaks")
...
plot(density(log2(K562_distances_to_TSS+1)), xlab="log2(distance to TSS)", main="K562 ATF3 peaks")
abline(v=log2(1000), col="red")
dev.off()
...
plot(density(log2(GM_distances_to_TSS+1)), xlab="log2(distance to TSS)", main="GM12878 ATF3 peaks")
abline(v=log2(1000), col="red")
dev.off()
...
plot(density(log2(H1_distances_to_TSS+1)), xlab="log2(distance to TSS)", main="H1-hESC ATF3 peaks")
abline(v=log2(1000), col="red")
dev.off()
...
plot(density(log2(Hepg2_distances_to_TSS+1)), xlab="log2(distance to TSS)", main="HepG2 ATF3 peaks")
abline(v=log2(1000), col="red")
dev.off()
